...
const smsPremium = () => { return `يتوفر هذا الأمر فقط للمستخدمين المتميزين وصانع البوت لي استخدام هذا امر يجراى شراء تذكرة من مطور\nمطور\nwa.me//+212607967755` }
...
const smsUnreg = () => { return `أنت بحاجة إلى التسجيل لاستخدام هذا الأمر\n\n*طريقة تسجيل*\n\n/make-account-mee7.19 maroc` }
...
const smsCont7 = () => { return `${global.lenguajeGB['smsAvisoAG']()}*ليس لديها ماسات 💎 يمكنك الذهاب إلى مطور وشراء ماسات*\n*مطور*\nwa.me//+212607967755`}
...
const smsCont18 = () => { return `*مكالمات غير مصرح بها لي هذا سأقوم بي حضرك اذا تم اتصال بي بوت عن طريق خطاء تواصل معا مطور هذا البوت*\nمطور\nwa.me//+212607967755`}
